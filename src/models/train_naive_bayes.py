...
def main():
    print("=== Phase 4: Naive Bayes Baseline Pipeline ===")
    ...
    print("      Đang train Multinomial Naive Bayes...")
    ...
    joblib.dump(model, MODEL_DIR / "naive_bayes_baseline.joblib")
    print(f"\n[THÀNH CÔNG] Đã lưu model tại: {MODEL_DIR / 'naive_bayes_baseline.joblib'}")
